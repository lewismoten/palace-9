...
$('train-reset').onclick=()=>{playing=false;trainer=null;chartHistory=[];$('train-status').textContent='Weights reset. Change layers/nodes, then Start.';$('train-outcome').textContent='No completed rounds yet.';drawChart()};
drawChart();
render();
